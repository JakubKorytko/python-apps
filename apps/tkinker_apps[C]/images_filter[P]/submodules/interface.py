...
class UIHandler:
    ...
    def get_navigation_state():
        ...
        navigation_state = {
            ...
            "Next": DISABLED if (
            UIHandler.image_index >= UIHandler.app_data["number_of_images"] - 1) else NORMAL,
        }
    ...
    def generate_ui():
        ...
        main_label = Label(image = UIHandler.app_data["filtered_images"][image_filter][image_index])
