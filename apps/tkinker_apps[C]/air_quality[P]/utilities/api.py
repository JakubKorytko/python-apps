...
class API:
    ...
    def fetch():
        ...
        try:
            api_requests_city = requests.get(
        ...
        for station_data in api_city:
            if (
                station_data["city"]["name"] == "Kraków"
                or station_data["city"]["commune"]["districtName"] == "krakowski"
            ):
                try:
                ...
                for sensor in sensors:
                    ...
                    cut_sensors.append({"name": sensor_name, "value": sensor_value})
        ...
        return {"stations": stations, "options": options}
    ...
    def api_error():
        ...
        print(
            "There was an error while fetching data from API. Please try again later."
        )
